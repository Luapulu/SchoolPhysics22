...
# ╔═╡ 3027c57e-7ae1-11ed-2c51-57585d3e8ade
using CairoMakie

# ╔═╡ 67a2c9e2-896b-4ae2-8edc-cb6da988bd25
using OrdinaryDiffEq

# ╔═╡ 4b39cffd-d295-410f-a16e-12a0b9541841
using LinearAlgebra

# ╔═╡ 9c604b80-0c0c-4578-ac42-e83bdceef47a
using PlutoUI: Slider

# ╔═╡ eea1ce9b-6d03-4e82-b7a9-34ac7142c80b
md"## Docs Links
...
# ╔═╡ 643f992f-2058-4c1c-9122-dce576fb5337
A = [1 2;
	 3 4]

# ╔═╡ 9facd6f6-9441-4f94-a676-968bd6030aaa
A[1, 2]

# ╔═╡ 636c3ab2-6b1b-4761-9c05-0054e968e029
A[2, :]

# ╔═╡ 8f0c86fd-8932-4a1e-90b5-2d0522052c37
A[1, 1] = 11

# ╔═╡ 9c3c5e99-0d54-419d-a369-6ba265dedf52
u = [5, 6]

# ╔═╡ ebab2567-6d56-4ff0-92b1-711eac751fa6
A * u

# ╔═╡ 3e956742-ca93-4149-961e-813ec176df2b
B = [i for i in 1:2, j in 1:2]

# ╔═╡ ffb0178b-216e-4b8e-ac62-04688c7f872a
A * B

# ╔═╡ 7d6b7b97-1386-49a1-bcdf-d40d1adc93c2
md"## Waves"

# ╔═╡ 05b666d7-5a6f-4c6a-b678-4b04ef2e37fc
N = 10

# ╔═╡ 6b398912-434d-4edc-b1b2-ef356402c0fd
masses = ones(N)

# ╔═╡ 10bd0974-7614-4dc9-bbfc-9cf64bb6c80c
# read: if true then 5, else 3
true ? 5 : 3

# ╔═╡ 61eac958-7b5d-4448-a010-7d1a6d08a0a3
indep(i, j) = i == j ? -1.0 : 0.0

# ╔═╡ a816c9f1-8a57-4e65-a873-23bdadf84a5d
function fixed(i, j)
	d = abs(i - j)
	if d == 0
		return -2
...
# ╔═╡ 49e0fabe-bbcd-40a6-9038-70809f607883
forces = Float64[fixed(i, j) for i in 1:N, j in 1:N]

# ╔═╡ 1368ae12-390a-4657-9662-7da58a3b78bd
vals, vecs = eigen(forces)

# ╔═╡ fcad2390-867c-4097-b8f1-180f93d6aac0
x0 = vecs[:, 1]

# ╔═╡ 2707912b-b924-4dd8-b2c3-605e251ee817
v0 = zeros(N)

# ╔═╡ 524fb344-357d-472b-ab71-605650752ec4
tend = 10.0

# ╔═╡ 50221bf9-eb3b-4438-8699-d1221049a794
# from F = m * a
acc!(a, v, x, p, t) = mul!(a, p.f, x) ./ p.m

# ╔═╡ 828b7b03-b8d2-4ea3-9503-00da900e0de8
prob = SecondOrderODEProblem{true}(acc!, v0, x0, (0.0, tend), (f = forces, m = masses))

# ╔═╡ 96f887ec-2855-4811-961f-c43c484d52b8
sol = solve(prob, McAte3(); dt=0.1)

# ╔═╡ ef2f599e-197f-4756-9d13-a5904a2688f9
# velocities at time 0.1
sol(0.1).x[1]

# ╔═╡ 0b1b7c71-387f-4d9c-ad95-bad38752238a
# positions at time 0.5
sol(0.5).x[2]

# ╔═╡ c6a5ead1-ddeb-424d-8991-3d0362f47aa7
@bind tplot Slider(range(0, tend, length=1_000))

# ╔═╡ 301e6bbe-a452-40db-a16d-c9afebc8737b
let fig = Figure()
	ax = Axis(fig[1, 1])
	ylims!(ax, (-2, 2))

	lines!(ax, sol(tplot).x[2])
...
julia_version = "1.8.3"
manifest_format = "2.0"
project_hash = "bd13fcc67cf3b52fc7ffccb2564f172b83455571"
...
deps = ["DocStringExtensions"]
git-tree-sha1 = "c45c06465cbdb334bb9f53a973217c217fcf5bdd"
